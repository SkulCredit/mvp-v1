  ...
  return (
    <>
      <div className="fixed inset-0 w-full h-full pointer-events-none -z-10 flex justify-center items-center overflow-hidden">
        ...
        <div className="absolute top-[20%] right-[15%] w-[400px] h-[400px] bg-brand-light/30 rounded-full mix-blend-multiply filter blur-[80px] animate-blob" style={{ animationDelay: '2s' }} />
      </div>
